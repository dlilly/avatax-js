 ...
 */var _isomorphicFetch=require('cross-fetch');var _isomorphicFetch2=_interopRequireDefault(_isomorphicFetch);var _basic_auth=require('./utils/basic_auth');function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _objectDestructuringEmpty(obj){if(obj==null)throw new TypeError("Cannot destructure undefined");}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var AvaTaxClient=function(){/**
   ...
   */},{key:'restCall',value:function restCall(_ref3){var url=_ref3.url,verb=_ref3.verb,payload=_ref3.payload;return(0,_isomorphicFetch2.default)(url,{method:verb,headers:{Accept:'application/json','Content-Type':'application/json',Authorization:this.auth,'X-Avalara-Client':this.clientId},body:JSON.stringify(payload)}).then(function(res){var contentType=res.headers && res.headers._headers && res.headers._headers['content-type'][0];if(contentType==='application/vnd.ms-excel'||contentType==='text/csv'){return res;}else{return res.json();}}).then(function(json){// handle error
...
url=url+'?'+qs;}return this.baseUrl+url;}/**
   ...
   * @return object
   */},{key:'deleteErrorTransactions',value:function deleteErrorTransactions(){var _ref148=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref148.model;var path=this.buildUrl({url:'/api/v2/errortransactions',parameters:{}});return this.restCall({url:path,verb:'delete',payload:model});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listErrorTransactions',value:function listErrorTransactions(){var _ref149=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref149.companyCode,filter=_ref149.filter,top=_ref149.top,skip=_ref149.skip,orderBy=_ref149.orderBy;var path=this.buildUrl({url:'/api/v2/errortransactions',parameters:{companyCode:companyCode,$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'approveFirmClientLinkage',value:function approveFirmClientLinkage(){var _ref150=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref150.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/approve',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * @return object
   */},{key:'createAndLinkNewFirmClientAccount',value:function createAndLinkNewFirmClientAccount(){var _ref151=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref151.model;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/createandlinkclient',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createFirmClientLinkage',value:function createFirmClientLinkage(){var _ref152=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref152.model;var path=this.buildUrl({url:'/api/v2/firmclientlinkages',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Delete a linkage
   *
   ...
   * 
     * @param int id 
   * @return object[]
   */},{key:'deleteFirmClientLinkage',value:function deleteFirmClientLinkage(){var _ref153=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref153.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'getFirmClientLinkage',value:function getFirmClientLinkage(){var _ref154=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref154.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return FetchResult
   */},{key:'listFirmClientLinkage',value:function listFirmClientLinkage(){var _ref155=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref155.filter;var path=this.buildUrl({url:'/api/v2/firmclientlinkages',parameters:{$filter:filter}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'rejectFirmClientLinkage',value:function rejectFirmClientLinkage(){var _ref156=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref156.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/reject',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'resetFirmClientLinkage',value:function resetFirmClientLinkage(){var _ref157=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref157.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/reset',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     * @param int id 
   * @return object
   */},{key:'revokeFirmClientLinkage',value:function revokeFirmClientLinkage(){var _ref158=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref158.id;var path=this.buildUrl({url:'/api/v2/firmclientlinkages/'+id+'/revoke',parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * @return object
   */},{key:'requestFreeTrial',value:function requestFreeTrial(){var _ref159=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref159.model;var path=this.buildUrl({url:'/api/v2/accounts/freetrials/request',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'taxRatesByAddress',value:function taxRatesByAddress(){var _ref160=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},line1=_ref160.line1,line2=_ref160.line2,line3=_ref160.line3,city=_ref160.city,region=_ref160.region,postalCode=_ref160.postalCode,country=_ref160.country;var path=this.buildUrl({url:'/api/v2/taxrates/byaddress',parameters:{line1:line1,line2:line2,line3:line3,city:city,region:region,postalCode:postalCode,country:country}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string postalCode The postal code of the location.
   * @return object
   */},{key:'taxRatesByPostalCode',value:function taxRatesByPostalCode(){var _ref161=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},country=_ref161.country,postalCode=_ref161.postalCode;var path=this.buildUrl({url:'/api/v2/taxrates/bypostalcode',parameters:{country:country,postalCode:postalCode}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'activateFundingRequest',value:function activateFundingRequest(){var _ref162=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref162.id;var path=this.buildUrl({url:'/api/v2/fundingrequests/'+id+'/widget',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     * @param int id The unique ID number of this funding request
   * @return object
   */},{key:'fundingRequestStatus',value:function fundingRequestStatus(){var _ref163=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref163.id;var path=this.buildUrl({url:'/api/v2/fundingrequests/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'batchDeleteItemClassifications',value:function batchDeleteItemClassifications(){var _ref164=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref164.companyId,itemId=_ref164.itemId;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications',parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'batchDeleteItemParameters',value:function batchDeleteItemParameters(){var _ref165=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref165.companyId,itemId=_ref165.itemId;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters',parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createItemClassifications',value:function createItemClassifications(){var _ref166=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref166.companyId,itemId=_ref166.itemId,model=_ref166.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createItemParameters',value:function createItemParameters(){var _ref167=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref167.companyId,itemId=_ref167.itemId,model=_ref167.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Create a new item
   *
   ...
   * @return object[]
   */},{key:'createItems',value:function createItems(){var _ref168=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref168.companyId,model=_ref168.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteItem',value:function deleteItem(){var _ref169=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref169.companyId,id=_ref169.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteItemClassification',value:function deleteItemClassification(){var _ref170=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref170.companyId,itemId=_ref170.itemId,id=_ref170.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteItemParameter',value:function deleteItemParameter(){var _ref171=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref171.companyId,itemId=_ref171.itemId,id=_ref171.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * 
     ...
     * @param string include A comma separated list of additional data to retrieve.
   * @return object
   */},{key:'getItem',value:function getItem(){var _ref172=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref172.companyId,id=_ref172.id,include=_ref172.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param int id The item classification id.
   * @return object
   */},{key:'getItemClassification',value:function getItemClassification(){var _ref173=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref173.companyId,itemId=_ref173.itemId,id=_ref173.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param int id The parameter id
   * @return object
   */},{key:'getItemParameter',value:function getItemParameter(){var _ref174=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref174.companyId,itemId=_ref174.itemId,id=_ref174.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listItemClassifications',value:function listItemClassifications(){var _ref175=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref175.companyId,itemId=_ref175.itemId,filter=_ref175.filter,top=_ref175.top,skip=_ref175.skip,orderBy=_ref175.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listItemParameters',value:function listItemParameters(){var _ref176=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref176.companyId,itemId=_ref176.itemId,filter=_ref176.filter,top=_ref176.top,skip=_ref176.skip,orderBy=_ref176.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listItemsByCompany',value:function listItemsByCompany(){var _ref177=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref177.companyId,filter=_ref177.filter,include=_ref177.include,top=_ref177.top,skip=_ref177.skip,orderBy=_ref177.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all items
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryItems',value:function queryItems(){var _ref178=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref178.filter,include=_ref178.include,top=_ref178.top,skip=_ref178.skip,orderBy=_ref178.orderBy;var path=this.buildUrl({url:'/api/v2/items',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'syncItems',value:function syncItems(){var _ref179=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref179.companyId,model=_ref179.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/sync',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'updateItem',value:function updateItem(){var _ref180=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref180.companyId,id=_ref180.id,model=_ref180.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * 
     ...
     * @param object model The item object you wish to update.
   * @return object
   */},{key:'updateItemClassification',value:function updateItemClassification(){var _ref181=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref181.companyId,itemId=_ref181.itemId,id=_ref181.id,model=_ref181.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/classifications/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * 
     ...
     * @param object model The item object you wish to update.
   * @return object
   */},{key:'updateItemParameter',value:function updateItemParameter(){var _ref182=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref182.companyId,itemId=_ref182.itemId,id=_ref182.id,model=_ref182.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/items/'+itemId+'/parameters/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createJurisdictionOverrides',value:function createJurisdictionOverrides(){var _ref183=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref183.accountId,model=_ref183.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'getJurisdictionOverride',value:function getJurisdictionOverride(){var _ref185=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref185.accountId,id=_ref185.id;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listJurisdictionOverridesByAccount',value:function listJurisdictionOverridesByAccount(){var _ref186=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref186.accountId,filter=_ref186.filter,include=_ref186.include,top=_ref186.top,skip=_ref186.skip,orderBy=_ref186.orderBy;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryJurisdictionOverrides',value:function queryJurisdictionOverrides(){var _ref187=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref187.filter,include=_ref187.include,top=_ref187.top,skip=_ref187.skip,orderBy=_ref187.orderBy;var path=this.buildUrl({url:'/api/v2/jurisdictionoverrides',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateJurisdictionOverride',value:function updateJurisdictionOverride(){var _ref188=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref188.accountId,id=_ref188.id,model=_ref188.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/jurisdictionoverrides/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createLocations',value:function createLocations(){var _ref189=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref189.companyId,model=_ref189.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteLocation',value:function deleteLocation(){var _ref190=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref190.companyId,id=_ref190.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getLocation',value:function getLocation(){var _ref191=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref191.companyId,id=_ref191.id,include=_ref191.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listLocationsByCompany',value:function listLocationsByCompany(){var _ref192=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref192.companyId,filter=_ref192.filter,include=_ref192.include,top=_ref192.top,skip=_ref192.skip,orderBy=_ref192.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryLocations',value:function queryLocations(){var _ref193=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref193.filter,include=_ref193.include,top=_ref193.top,skip=_ref193.skip,orderBy=_ref193.orderBy;var path=this.buildUrl({url:'/api/v2/locations',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateLocation',value:function updateLocation(){var _ref194=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref194.companyId,id=_ref194.id,model=_ref194.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * 
     ...
     * @param int id The primary key of this location
   * @return object
   */},{key:'validateLocation',value:function validateLocation(){var _ref195=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref195.companyId,id=_ref195.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id+'/validate',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'adjustMultiDocumentTransaction',value:function adjustMultiDocumentTransaction(){var _ref196=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},code=_ref196.code,type=_ref196.type,include=_ref196.include,model=_ref196.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+code+'/type/'+type+'/adjust',parameters:{include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string type The transaction type for this MultiDocument transaction (See DocumentType::* for a list of allowable values)
   * @return object
   */},{key:'auditMultiDocumentTransaction',value:function auditMultiDocumentTransaction(){var _ref197=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},code=_ref197.code,type=_ref197.type;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+code+'/type/'+type+'/audit',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'commitMultiDocumentTransaction',value:function commitMultiDocumentTransaction(){var _ref198=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref198.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/commit',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createMultiDocumentTransaction',value:function createMultiDocumentTransaction(){var _ref199=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref199.include,model=_ref199.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in the response after transaction is created
   * @return object
   */},{key:'getMultiDocumentTransactionById',value:function getMultiDocumentTransactionById(){var _ref201=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref201.id,include=_ref201.include;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listMultiDocumentTransactions',value:function listMultiDocumentTransactions(){var _ref202=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref202.filter,include=_ref202.include,top=_ref202.top,skip=_ref202.skip,orderBy=_ref202.orderBy;var path=this.buildUrl({url:'/api/v2/transactions/multidocument',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'verifyMultiDocumentTransaction',value:function verifyMultiDocumentTransaction(){var _ref204=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref204.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/verify',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'voidMultiDocumentTransaction',value:function voidMultiDocumentTransaction(){var _ref205=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},code=_ref205.code,type=_ref205.type,model=_ref205.model;var path=this.buildUrl({url:'/api/v2/transactions/multidocument/'+code+'/type/'+type+'/void',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Create a new nexus
   *
   ...
   * @return object[]
   */},{key:'createNexus',value:function createNexus(){var _ref206=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref206.companyId,model=_ref206.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param object[] model The nexus you wish to create.
   * @return object[]
   */},{key:'declareNexusByAddress',value:function declareNexusByAddress(){var _ref207=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref207.companyId,model=_ref207.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/byaddress',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteNexus',value:function deleteNexus(){var _ref208=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref208.companyId,id=_ref208.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getNexus',value:function getNexus(){var _ref209=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref209.companyId,id=_ref209.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string formCode The form code that we are looking up the nexus for
   * @return object
   */},{key:'getNexusByFormCode',value:function getNexusByFormCode(){var _ref210=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref210.companyId,formCode=_ref210.formCode;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/byform/'+formCode,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listNexusByCompany',value:function listNexusByCompany(){var _ref211=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref211.companyId,filter=_ref211.filter,include=_ref211.include,top=_ref211.top,skip=_ref211.skip,orderBy=_ref211.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all nexus
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryNexus',value:function queryNexus(){var _ref212=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref212.filter,include=_ref212.include,top=_ref212.top,skip=_ref212.skip,orderBy=_ref212.orderBy;var path=this.buildUrl({url:'/api/v2/nexus',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateNexus',value:function updateNexus(){var _ref213=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref213.companyId,id=_ref213.id,model=_ref213.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/nexus/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'dismissNotification',value:function dismissNotification(){var _ref214=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref214.id;var path=this.buildUrl({url:'/api/v2/notifications/'+id+'/dismiss',parameters:{}});return this.restCall({url:path,verb:'put',payload:null});}/**
   ...
   * @return object
   */},{key:'getNotification',value:function getNotification(){var _ref215=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref215.id;var path=this.buildUrl({url:'/api/v2/notifications/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listNotifications',value:function listNotifications(){var _ref216=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref216.filter,top=_ref216.top,skip=_ref216.skip,orderBy=_ref216.orderBy;var path=this.buildUrl({url:'/api/v2/notifications',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'requestNewAccount',value:function requestNewAccount(){var _ref217=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref217.model;var path=this.buildUrl({url:'/api/v2/accounts/request',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'requestNewEntitlement',value:function requestNewEntitlement(){var _ref218=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref218.id,offer=_ref218.offer;var path=this.buildUrl({url:'/api/v2/accounts/'+id+'/entitlements/'+offer,parameters:{}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createAccount',value:function createAccount(){var _ref219=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref219.model;var path=this.buildUrl({url:'/api/v2/accounts',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createNotifications',value:function createNotifications(){var _ref220=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref220.model;var path=this.buildUrl({url:'/api/v2/notifications',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'createSubscriptions',value:function createSubscriptions(){var _ref221=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref221.accountId,model=_ref221.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteAccount',value:function deleteAccount(){var _ref222=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref222.id;var path=this.buildUrl({url:'/api/v2/accounts/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteNotification',value:function deleteNotification(){var _ref223=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref223.id;var path=this.buildUrl({url:'/api/v2/notifications/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object[]
   */},{key:'deleteSubscription',value:function deleteSubscription(){var _ref224=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref224.accountId,id=_ref224.id;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return string
   */},{key:'resetPassword',value:function resetPassword(){var _ref225=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},userId=_ref225.userId,unmigrateFromAi=_ref225.unmigrateFromAi,model=_ref225.model;var path=this.buildUrl({url:'/api/v2/passwords/'+userId+'/reset',parameters:{unmigrateFromAi:unmigrateFromAi}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'updateAccount',value:function updateAccount(){var _ref226=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref226.id,model=_ref226.model;var path=this.buildUrl({url:'/api/v2/accounts/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'updateNotification',value:function updateNotification(){var _ref227=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref227.id,model=_ref227.model;var path=this.buildUrl({url:'/api/v2/notifications/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'updateSubscription',value:function updateSubscription(){var _ref228=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref228.accountId,id=_ref228.id,model=_ref228.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   * Download a report
   *
   ...
   * @return object
   */},{key:'downloadReport',value:function downloadReport(){var _ref229=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref229.id;var path=this.buildUrl({url:'/api/v2/reports/'+id+'/attachment',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'getReport',value:function getReport(){var _ref230=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref230.id;var path=this.buildUrl({url:'/api/v2/reports/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'initiateExportDocumentLineReport',value:function initiateExportDocumentLineReport(){var _ref231=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref231.companyId,model=_ref231.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/reports/exportdocumentline/initiate',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param int top If nonzero, return no more than this number of results. Used with `$skip` to provide pagination for large datasets. Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records.
   * @return FetchResult
   */},{key:'listReports',value:function listReports(){var _ref232=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref232.companyId,pageKey=_ref232.pageKey,skip=_ref232.skip,top=_ref232.top;var path=this.buildUrl({url:'/api/v2/reports',parameters:{companyId:companyId,pageKey:pageKey,$skip:skip,$top:top}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createSettings',value:function createSettings(){var _ref233=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref233.companyId,model=_ref233.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteSetting',value:function deleteSetting(){var _ref234=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref234.companyId,id=_ref234.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getSetting',value:function getSetting(){var _ref235=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref235.companyId,id=_ref235.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listSettingsByCompany',value:function listSettingsByCompany(){var _ref236=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref236.companyId,filter=_ref236.filter,include=_ref236.include,top=_ref236.top,skip=_ref236.skip,orderBy=_ref236.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'querySettings',value:function querySettings(){var _ref237=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref237.filter,include=_ref237.include,top=_ref237.top,skip=_ref237.skip,orderBy=_ref237.orderBy;var path=this.buildUrl({url:'/api/v2/settings',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateSetting',value:function updateSetting(){var _ref238=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref238.companyId,id=_ref238.id,model=_ref238.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/settings/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'getSubscription',value:function getSubscription(){var _ref239=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref239.accountId,id=_ref239.id;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listSubscriptionsByAccount',value:function listSubscriptionsByAccount(){var _ref240=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref240.accountId,filter=_ref240.filter,top=_ref240.top,skip=_ref240.skip,orderBy=_ref240.orderBy;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/subscriptions',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'querySubscriptions',value:function querySubscriptions(){var _ref241=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref241.filter,top=_ref241.top,skip=_ref241.skip,orderBy=_ref241.orderBy;var path=this.buildUrl({url:'/api/v2/subscriptions',parameters:{$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createTaxCodes',value:function createTaxCodes(){var _ref242=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref242.companyId,model=_ref242.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteTaxCode',value:function deleteTaxCode(){var _ref243=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref243.companyId,id=_ref243.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getTaxCode',value:function getTaxCode(){var _ref244=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref244.companyId,id=_ref244.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listTaxCodesByCompany',value:function listTaxCodesByCompany(){var _ref245=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref245.companyId,filter=_ref245.filter,include=_ref245.include,top=_ref245.top,skip=_ref245.skip,orderBy=_ref245.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryTaxCodes',value:function queryTaxCodes(){var _ref246=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref246.filter,include=_ref246.include,top=_ref246.top,skip=_ref246.skip,orderBy=_ref246.orderBy;var path=this.buildUrl({url:'/api/v2/taxcodes',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateTaxCode',value:function updateTaxCode(){var _ref247=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref247.companyId,id=_ref247.id,model=_ref247.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxcodes/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'buildTaxContentFile',value:function buildTaxContentFile(){var _ref248=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref248.model;var path=this.buildUrl({url:'/api/v2/pointofsaledata/build',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'buildTaxContentFileForLocation',value:function buildTaxContentFileForLocation(){var _ref249=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref249.companyId,id=_ref249.id,date=_ref249.date,format=_ref249.format,partnerId=_ref249.partnerId,includeJurisCodes=_ref249.includeJurisCodes;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/locations/'+id+'/pointofsaledata',parameters:{date:date,format:format,partnerId:partnerId,includeJurisCodes:includeJurisCodes}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'downloadTaxRatesByZipCode',value:function downloadTaxRatesByZipCode(){var _ref250=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},date=_ref250.date,region=_ref250.region;var path=this.buildUrl({url:'/api/v2/taxratesbyzipcode/download/'+date,parameters:{region:region}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object[]
   */},{key:'createTaxRules',value:function createTaxRules(){var _ref251=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref251.companyId,model=_ref251.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteTaxRule',value:function deleteTaxRule(){var _ref252=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref252.companyId,id=_ref252.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getTaxRule',value:function getTaxRule(){var _ref253=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref253.companyId,id=_ref253.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listTaxRules',value:function listTaxRules(){var _ref254=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref254.companyId,filter=_ref254.filter,include=_ref254.include,top=_ref254.top,skip=_ref254.skip,orderBy=_ref254.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryTaxRules',value:function queryTaxRules(){var _ref255=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref255.filter,include=_ref255.include,top=_ref255.top,skip=_ref255.skip,orderBy=_ref255.orderBy;var path=this.buildUrl({url:'/api/v2/taxrules',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateTaxRule',value:function updateTaxRule(){var _ref256=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref256.companyId,id=_ref256.id,model=_ref256.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/taxrules/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'addLines',value:function addLines(){var _ref257=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref257.include,model=_ref257.model;var path=this.buildUrl({url:'/api/v2/companies/transactions/lines/add',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'adjustTransaction',value:function adjustTransaction(){var _ref258=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref258.companyCode,transactionCode=_ref258.transactionCode,documentType=_ref258.documentType,include=_ref258.include,model=_ref258.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/adjust',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'auditTransaction',value:function auditTransaction(){var _ref259=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref259.companyCode,transactionCode=_ref259.transactionCode;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/audit',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Get audit information about a transaction
   *
   * Retrieve audit information about a transaction stored in AvaTax.
     *  
   ...
   * @return object
   */},{key:'auditTransactionWithType',value:function auditTransactionWithType(){var _ref260=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref260.companyCode,transactionCode=_ref260.transactionCode,documentType=_ref260.documentType;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/types/'+documentType+'/audit',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'bulkLockTransaction',value:function bulkLockTransaction(){var _ref261=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref261.model;var path=this.buildUrl({url:'/api/v2/transactions/lock',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'changeTransactionCode',value:function changeTransactionCode(){var _ref262=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref262.companyCode,transactionCode=_ref262.transactionCode,documentType=_ref262.documentType,include=_ref262.include,model=_ref262.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/changecode',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param object model The commit request you wish to execute
   * @return object
   */},{key:'commitTransaction',value:function commitTransaction(){var _ref263=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref263.companyCode,transactionCode=_ref263.transactionCode,documentType=_ref263.documentType,include=_ref263.include,model=_ref263.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/commit',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createOrAdjustTransaction',value:function createOrAdjustTransaction(){var _ref264=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref264.include,model=_ref264.model;var path=this.buildUrl({url:'/api/v2/transactions/createoradjust',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'createTransaction',value:function createTransaction(){var _ref265=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref265.include,model=_ref265.model;var path=this.buildUrl({url:'/api/v2/transactions/create',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'deleteLines',value:function deleteLines(){var _ref266=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref266.include,model=_ref266.model;var path=this.buildUrl({url:'/api/v2/companies/transactions/lines/delete',parameters:{$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'getTransactionByCode',value:function getTransactionByCode(){var _ref267=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref267.companyCode,transactionCode=_ref267.transactionCode,documentType=_ref267.documentType,include=_ref267.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode,parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve a single transaction by code
   *
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'getTransactionByCodeAndType',value:function getTransactionByCodeAndType(){var _ref268=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref268.companyCode,transactionCode=_ref268.transactionCode,documentType=_ref268.documentType,include=_ref268.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/types/'+documentType,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'getTransactionById',value:function getTransactionById(){var _ref269=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref269.id,include=_ref269.include;var path=this.buildUrl({url:'/api/v2/transactions/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listTransactionsByCompany',value:function listTransactionsByCompany(){var _ref270=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref270.companyCode,dataSourceId=_ref270.dataSourceId,include=_ref270.include,filter=_ref270.filter,top=_ref270.top,skip=_ref270.skip,orderBy=_ref270.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions',parameters:{dataSourceId:dataSourceId,$include:include,$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'lockTransaction',value:function lockTransaction(){var _ref271=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref271.companyCode,transactionCode=_ref271.transactionCode,documentType=_ref271.documentType,include=_ref271.include,model=_ref271.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/lock',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param object model Information about the refund to create
   * @return object
   */},{key:'refundTransaction',value:function refundTransaction(){var _ref272=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref272.companyCode,transactionCode=_ref272.transactionCode,include=_ref272.include,documentType=_ref272.documentType,useTaxDateOverride=_ref272.useTaxDateOverride,model=_ref272.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/refund',parameters:{$include:include,documentType:documentType,useTaxDateOverride:useTaxDateOverride}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object
   */},{key:'settleTransaction',value:function settleTransaction(){var _ref273=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref273.companyCode,transactionCode=_ref273.transactionCode,documentType=_ref273.documentType,include=_ref273.include,model=_ref273.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/settle',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'uncommitTransaction',value:function uncommitTransaction(){var _ref274=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref274.companyCode,transactionCode=_ref274.transactionCode,documentType=_ref274.documentType,include=_ref274.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/uncommit',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     ...
     * @param string include Specifies objects to include in this fetch call
   * @return object
   */},{key:'unvoidTransaction',value:function unvoidTransaction(){var _ref275=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref275.companyCode,transactionCode=_ref275.transactionCode,documentType=_ref275.documentType,include=_ref275.include;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/unvoid',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:null});}/**
   ...
   * 
     ...
     * @param object model The data from an external system to reconcile against AvaTax
   * @return object
   */},{key:'verifyTransaction',value:function verifyTransaction(){var _ref276=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref276.companyCode,transactionCode=_ref276.transactionCode,documentType=_ref276.documentType,include=_ref276.include,model=_ref276.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/verify',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Void a transaction
   *
   * Voids the current transaction uniquely identified by this URL.
     *  
   ...
   * @return object
   */},{key:'voidTransaction',value:function voidTransaction(){var _ref277=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyCode=_ref277.companyCode,transactionCode=_ref277.transactionCode,documentType=_ref277.documentType,include=_ref277.include,model=_ref277.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyCode+'/transactions/'+transactionCode+'/void',parameters:{documentType:documentType,$include:include}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Create a new UPC
   *
   ...
   * @return object[]
   */},{key:'createUPCs',value:function createUPCs(){var _ref278=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref278.companyId,model=_ref278.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   * Delete a single UPC
   *
   ...
   * @return object[]
   */},{key:'deleteUPC',value:function deleteUPC(){var _ref279=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref279.companyId,id=_ref279.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getUPC',value:function getUPC(){var _ref280=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref280.companyId,id=_ref280.id;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs/'+id,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listUPCsByCompany',value:function listUPCsByCompany(){var _ref281=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref281.companyId,filter=_ref281.filter,include=_ref281.include,top=_ref281.top,skip=_ref281.skip,orderBy=_ref281.orderBy;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all UPCs
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryUPCs',value:function queryUPCs(){var _ref282=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},filter=_ref282.filter,include=_ref282.include,top=_ref282.top,skip=_ref282.skip,orderBy=_ref282.orderBy;var path=this.buildUrl({url:'/api/v2/upcs',parameters:{$filter:filter,$include:include,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Update a single UPC
   *
   ...
   * @return object
   */},{key:'updateUPC',value:function updateUPC(){var _ref283=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},companyId=_ref283.companyId,id=_ref283.id,model=_ref283.model;var path=this.buildUrl({url:'/api/v2/companies/'+companyId+'/upcs/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   * Change Password
   *
   ...
   * @return string
   */},{key:'changePassword',value:function changePassword(){var _ref284=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},model=_ref284.model;var path=this.buildUrl({url:'/api/v2/passwords',parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   * Create new users
   *
   ...
   * @return object[]
   */},{key:'createUsers',value:function createUsers(){var _ref285=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref285.accountId,model=_ref285.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users',parameters:{}});return this.restCall({url:path,verb:'post',payload:model});}/**
   ...
   * @return object[]
   */},{key:'deleteUser',value:function deleteUser(){var _ref286=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref286.id,accountId=_ref286.accountId;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id,parameters:{}});return this.restCall({url:path,verb:'delete',payload:null});}/**
   ...
   * @return object
   */},{key:'getUser',value:function getUser(){var _ref287=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref287.id,accountId=_ref287.accountId,include=_ref287.include;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id,parameters:{$include:include}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param int accountId The accountID of the user you wish to get.
   * @return object
   */},{key:'getUserEntitlements',value:function getUserEntitlements(){var _ref288=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref288.id,accountId=_ref288.accountId;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id+'/entitlements',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'listUsersByAccount',value:function listUsersByAccount(){var _ref289=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},accountId=_ref289.accountId,include=_ref289.include,filter=_ref289.filter,top=_ref289.top,skip=_ref289.skip,orderBy=_ref289.orderBy;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users',parameters:{$include:include,$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   * Retrieve all users
   *
   ...
   * 
     ...
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   */},{key:'queryUsers',value:function queryUsers(){var _ref290=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},include=_ref290.include,filter=_ref290.filter,top=_ref290.top,skip=_ref290.skip,orderBy=_ref290.orderBy;var path=this.buildUrl({url:'/api/v2/users',parameters:{$include:include,$filter:filter,$top:top,$skip:skip,$orderBy:orderBy}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * @return object
   */},{key:'updateUser',value:function updateUser(){var _ref291=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},id=_ref291.id,accountId=_ref291.accountId,model=_ref291.model;var path=this.buildUrl({url:'/api/v2/accounts/'+accountId+'/users/'+id,parameters:{}});return this.restCall({url:path,verb:'put',payload:model});}/**
   ...
   * @return object
   */},{key:'getMySubscription',value:function getMySubscription(){var _ref292=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},serviceTypeId=_ref292.serviceTypeId;var path=this.buildUrl({url:'/api/v2/utilities/subscriptions/'+serviceTypeId,parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
   * @return FetchResult
   */},{key:'listMySubscriptions',value:function listMySubscriptions(){var _ref293=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};_objectDestructuringEmpty(_ref293);var path=this.buildUrl({url:'/api/v2/utilities/subscriptions',parameters:{}});return this.restCall({url:path,verb:'get',payload:null});}/**
   ...
   * 
   * @return object
   */},{key:'ping',value:function ping(){var _ref294=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};_objectDestructuringEmpty(_ref294);var path=this.buildUrl({url:'/api/v2/utilities/ping',parameters:{}});return this.restCall({url:path,verb:'get',payload:undefined});}}]);return AvaTaxClient;}();exports.default=AvaTaxClient;